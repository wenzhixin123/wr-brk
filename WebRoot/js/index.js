...
//				url = "ajaxPageWrapper.jsp?_title=" + encodeURI(encodeURI(currTab.panel("options").title)) + "&_ajaxPageUrl=" + currTab.panel("options").href;
//			} else {
...
//	}
	...
	function openWindow(parent,subtitle,url,type,options, iconCls) {
