...
jQuery.fn.slideViewerPro = function(settings) {
	  settings = jQuery.extend({
			...
			leftButtonInner: "<img src='./images/left.png' />", //could be an image "<img src='images/larw.gif' />" or an escaped char as "&larr";
			rightButtonInner: "<img src='./images/right.png' />", //could be an image or an escaped char as "&rarr";
			autoslide: false,
			typo: false,
			typoFullOpacity: 0.9,
			shuffle: false
    ...
    .wrap(jQuery("<div style='width:"+ pictWidth +"px; overflow: hidden; position: relative; top: 0; left: 0'>"));
		...
		container.each(function(i) {
			...
			jQuery(this).find("li").each(function(n) { 
						jQuery("div#thumbSlider" + j + " ul").append("<li><a title='" + jQuery(this).find("img").attr("alt") + "' href='" + jQuery(this).find("img").attr("src") + "' rel='" + jQuery(this).find("img").attr("rel") + "'><img width='"+ thumbsWidth +"' height='"+ thumbsHeight +"' src='" + jQuery(this).find("img").attr("src") + "' /><p class='tmbrdr'>&nbsp;<\/p><\/a><\/li>");						
			});
