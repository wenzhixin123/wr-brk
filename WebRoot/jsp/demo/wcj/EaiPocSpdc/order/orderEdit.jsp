...
<%--			<input name="consigneeName"/>--%>
			<input name="consigner" class="easyui-combogrid" codetype="CIM_CUST"/>
				...
				<div fit="true" class="easyui-layout">
					...
					<div region="center" border="false">
						<div fit="true" class="easyui-layout">
							...
							<div region="north" style="height: 125px; padding: 0px 5px 5px 5px;" border="false">
								<div class="datagrid-toolbar">
								...
								<table id="gridOutContainer" class="easyui-datagrid" i18nRoot="LogisticsContainer" fit="true"
									...
									<thead>
										<tr>
											...
											<th field="operatorComp" editor="combogrid" codetype="CIM_CUST"/>
											<th field="ownerComp" editor="combogrid" codetype="CIM_CUST"/>
