...
<body class="easyui-layout">
	...
	<div region="center" border="false">
		<div class="easyui-layout" fit="true">
			...
			<div region="north" style="height: 125px;">
				<div class="datagrid-toolbar">
				...
				<table id="gridContainer" class="easyui-datagrid" i18nRoot="LogisticsContainer" fit="true" border="false"
					...
					<thead>
						<tr>
							...
							<th field="operatorComp" editor="combogrid" codetype="CIM_CUST" width="100"/>
							<th field="ownerComp" editor="combogrid" codetype="CIM_CUST" width="100"/>
