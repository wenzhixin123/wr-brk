...
/**
 * Model class for 作业单集装箱信息
 */
@Entity
@Table(name = "LOGISTICS_ORDER_CONTAINER")
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
public class LogisticsOrderContainerModel extends BaseModelClass implements
		OperationLog {

	private static final long serialVersionUID = 1L;

	public static final String MODEL_NAME = "LogisticsOrderContainer";

	public static final class FieldNames {
		/**
		 * 主键
		 */
		public static final String logisticsOrderConUuid = "logisticsOrderConUuid";
		/**
		 * 作业单UUID
		 */
	...
	// 主键
	private String logisticsOrderConUuid;
	// 作业单UUID
	 ...
	 * Get 主键
	 */
	@Column(name = "LOGISTICS_ORDER_CON_UUID")
	@Id
	@GeneratedValue(generator = "UUIDGenerator")
	public String getLogisticsOrderConUuid() {
		return logisticsOrderConUuid;
	}

	/**
	 * Set 主键
	 */
	public void setLogisticsOrderConUuid(String logisticsOrderConUuid) {
		this.logisticsOrderConUuid = logisticsOrderConUuid;
		addValidField(FieldNames.logisticsOrderConUuid);
	}
	 ...
	 * 
	 */
	private String prrmaryKeyName="logisticsOrderConUuid";
	@Transient
