...
/**
 * Model class for 委托订单操作记录
 */
@Entity
@Table(name = "SUBMIT_ORDER_LOG")
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
public class SubmitOrderLogModel extends BaseModelClass implements OperationLog {

	private static final long serialVersionUID = 1L;

	public static final String MODEL_NAME = "SubmitOrderLog";

	public static final class FieldNames {
		/**
		 * 操作记录的UUID
		 */
		public static final String submitOrderLogUuid = "submitOrderLogUuid";
		/**
		 * 委托单UUID号
		 */
	 ...
	 * Get 操作记录的UUID
	 */
	@Column(name = "SUBMIT_ORDER_LOG_UUID")
	@Id @GeneratedValue(generator = "UUIDGenerator")
	public String getSubmitOrderLogUuid() {
		return submitOrderLogUuid;
	}

	/**
	 * Set 操作记录的UUID
	 */
	public void setSubmitOrderLogUuid(String submitOrderLogUuid) {
		this.submitOrderLogUuid = submitOrderLogUuid;
		addValidField(FieldNames.submitOrderLogUuid);
	}
	 ...
	 * 
	 */
	private String prrmaryKeyName="submitOrderLogUuid";
	@Transient
