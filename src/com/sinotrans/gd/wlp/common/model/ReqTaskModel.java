...
/**
 * Model class for ReqTask
 */
@Entity
@Table(name = "req_task")
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
public class ReqTaskModel extends BaseModelClass {

	private static final long serialVersionUID = 1L;

	public static final String MODEL_NAME = "ReqTask";
	...
	public static final class FieldNames {
		 ...
		 * taskTyp
		 */
		public static final String taskTyp = "taskTyp";
		/**
		 * userCallCode
		 */
		 ...
		 * podDir
		 */
		public static final String podDir = "podDir";
		/**
		 * priority
		 */
		 ...
		 * robotCode
		 */
		public static final String robotCode = "robotCode";
		/**
		 * data
		 */
		 ...
		 * reqTaskId
		 */
		public static final String reqTaskId = "reqTaskId";
		/**
		 * createTime
		 */
		 ...
		 * creator
		 */
		public static final String currentCallCode = "currentCallCode";
		/**
		 * userCallCodePath
		 */
		public static final String userCallCodePath = "userCallCodePath";
	}
	...
	public void setUserCallCodePath(String userCallCodePath) {
		...
		addValidField(FieldNames.userCallCodePath);
	}
	...
	public void setCurrentCallCode(String currentCallCode) {
		...
		addValidField(FieldNames.currentCallCode);
	}
	...
	public void setTaskTyp(String taskTyp) {
		...
		addValidField(FieldNames.taskTyp);
	}
	...
	public void setPodDir(String podDir) {
		this.podDir = podDir;
		addValidField(FieldNames.podDir);
	}
	...
	public void setPriority(String priority) {
		...
		addValidField(FieldNames.priority);
	}
	...
	public void setTaskCode(String taskCode) {
		...
		addValidField(FieldNames.taskCode);
	}
	...
	public void setRobotCode(String robotCode) {
		...
		addValidField(FieldNames.robotCode);
	}
	...
	public void setTaskStatus(Integer taskStatus) {
		...
		addValidField(FieldNames.taskStatus);
	}
	...
	public void setReqTaskId(String reqTaskId) {
		...
		addValidField(FieldNames.reqTaskId);
	}
