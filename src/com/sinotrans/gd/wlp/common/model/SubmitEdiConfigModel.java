...
/**
 * Model class for 委托订单EDI配置
 */
@Entity
@Table(name = "SUBMIT_EDI_CONFIG")
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
public class SubmitEdiConfigModel extends BaseModelClass implements OperationLog {

	private static final long serialVersionUID = 1L;

	public static final String MODEL_NAME = "SubmitEdiConfig";

	public static final class FieldNames {
		/**
		 * 操作记录的UUID
		 */
		public static final String submitEdiConfigUuid = "submitEdiConfigUuid";
		/**
		 * 委托单UUID号
		 */
	...
	//操作记录的UUID
	private String submitEdiConfigUuid;
	//委托单UUID号
	 ...
	 * Get 操作记录的UUID
	 */
	@Column(name = "SUBMIT_EDI_CONFIG_UUID")
	@Id @GeneratedValue(generator = "UUIDGenerator")
	public String getSubmitEdiConfigUuid() {
		return submitEdiConfigUuid;
	}

	/**
	 * Set 操作记录的UUID
	 */
	public void setSubmitEdiConfigUuid(String submitEdiConfigUuid) {
		this.submitEdiConfigUuid = submitEdiConfigUuid;
		addValidField(FieldNames.submitEdiConfigUuid);
	}
	 ...
	 * 
	 */
	private String prrmaryKeyName="submitEdiConfigUuid";
	@Transient
