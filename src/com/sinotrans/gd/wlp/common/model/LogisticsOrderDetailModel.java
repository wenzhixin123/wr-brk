...
/**
 * Model class for 作业单明细
 */
@Entity
@Table(name = "LOGISTICS_ORDER_DETAIL")
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
public class LogisticsOrderDetailModel extends BaseModelClass implements
		OperationLog {

	private static final long serialVersionUID = 1L;

	public static final String MODEL_NAME = "LogisticsOrderDetail";
	 ...
	 * 
	 */
	private String prrmaryKeyName="logisticsOrderDetailUuid";
	@Transient
