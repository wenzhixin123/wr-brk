...
@Entity
public class YclCheckHasPickQueryItem extends BaseQueryItem {

	private String rsInLodUuid;
	private String outLodUuid;
	private Double qty;
	private Double lodQty;
	private Double canPickQty;
	...
	private String rsInStockWorkUuid;
	private Double remainQty;
	private String lotCode;
	private String rsBarcode;
	...
	@Column(name = "CAN_OUT_QTY")
	public Double getCanOutQty() {
		return canOutQty;
	}
	
	public void setCanOutQty(Double canOutQty) {
		this.canOutQty = canOutQty;
		addValidField("canOutQty");
	}
	...
	@Column(name = "CAN_PICK_QTY")
	public Double getCanPickQty() {
		return canPickQty;
	}

	public void setCanPickQty(Double canPickQty) {
		this.canPickQty = canPickQty;
		addValidField("canPickQty");
	}
	...
	@Column(name = "RS_IN_STOCK_WORK_UUID")
	public String getRsInStockWorkUuid() {
		return rsInStockWorkUuid;
	}

	public void setRsInStockWorkUuid(String rsInStockWorkUuid) {
		this.rsInStockWorkUuid = rsInStockWorkUuid;
		addValidField("rsInStockWorkUuid");
	}
	...
	@Column(name = "RS_BARCODE")
	public String getRsBarcode() {
		return rsBarcode;
	}

	public void setRsBarcode(String rsBarcode) {
		this.rsBarcode = rsBarcode;
		addValidField("rsBarcode");
	}
