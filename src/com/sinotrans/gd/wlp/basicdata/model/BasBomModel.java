...
/**
 * Model class for 物料清单
 */
@Entity
@Table(name = "BAS_BOM")
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
public class BasBomModel extends BaseModelClass implements OperationLog {

	private static final long serialVersionUID = 1L;

	public static final String MODEL_NAME = "BasBom";
	...
	public static final class FieldNames {
		 ...
		 * bomNameEn
		 */
		public static final String bomNameEn = "bomNameEn";
		/**
		 * 物料编码
		 */
	...
	public void setBomName(String bomName) {
		...
		addValidField(FieldNames.bomName);
	}

	/**
	 * Get bomNameEn
	 */
	@Column(name = "BOM_NAME_EN")
	public String getBomNameEn() {
		return bomNameEn;
	}
	 ...
	 * Set bomNameEn
	 */
	public void setBomNameEn(String bomNameEn) {
		this.bomNameEn = bomNameEn;
		addValidField(FieldNames.bomNameEn);
	}
	 ...
	 * 
	 */
	private String prrmaryKeyName="basBomTypeUuid";
	@Transient
