...
public class BasCustomerModel extends BaseModelClass implements OperationLog {
	...
	/**
	 * Get 01表示办事处
	 * ，02表示国际中转代理，03表示机械作业单位，04表示船公司，05表示一程船公司，06表示控箱公司，07表示货代，08表示付货人
	 * ，09表示收货人，10表示工厂，11表示贸易公司，12表示代理，13表示车队，14表示其他
	 */
	 ...
	 * 
	 */
	private String prrmaryKeyName = "basCustomerUuid";
	...
	public boolean equals(Object o) {
		...
		if (o != null && o instanceof BasCustomerModel) {
			BasCustomerModel ps = (BasCustomerModel) o;
			equals = (new EqualsBuilder().append(this.cityCode,
					ps.getCityCode()).append(this.countryCode,
					ps.getCountryCode()).isEquals());
		}
		return equals;
	}
...
//		// 01表示办事处
//		private String customerType;
//		return new HashCodeBuilder(17, 37).append(this.basCustomerUuid)
//				.append(this.customerCode)
//				.append(this.customerName)
//				.append(this.customerNameEn)
