...
/**
 * Model class for 城市维护
 */
@Entity
@Table(name = "BAS_CITY")
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
public class BasCityModel extends BaseModelClass implements OperationLog {

	private static final long serialVersionUID = 1L;

	public static final String MODEL_NAME = "BasCity";

	public static final class FieldNames {
		/**
		 * Phisical
		 */
		public static final String basCityUuid = "basCityUuid";
		/**
		 * 城市代码
		 */
	 ...
	 */
	@Column(name = "BAS_CITY_UUID")
	@Id
	@GeneratedValue(generator = "UUIDGenerator")
	public String getBasCityUuid() {
		return basCityUuid;
	}
	 ...
	 */
	public void setBasCityUuid(String basCityUuid) {
		this.basCityUuid = basCityUuid;
		addValidField(FieldNames.basCityUuid);
	}
	 ...
	 * 
	 */
	private String prrmaryKeyName="basCityUuid";
	@Transient
