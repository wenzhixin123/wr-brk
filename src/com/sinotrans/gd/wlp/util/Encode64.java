...
public class Encode64 {
	...
	public static String decode(String s) {
		...
		if (StringUtils.isBlank(s))
			return result;
		try {
			result = new String(decodeFast(s), "UTF-8");
	...
	public static String decodeGB2312(String s) {
		...
		if (StringUtils.isBlank(s))
			return result;
		try {
			result = new String(decodeFast(s), "GB2312");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
		}
		return result;
	...
	public final static String decodeTogbk(String s) {
		String result = "";
		if (StringUtils.isBlank(s))
			return "";
    ...
    public static String encodeBase64(String data) {
        try {
			return encodeBase64(data.getBytes("GB2312"));
		} catch (UnsupportedEncodingException e) {
    ...
    public static String decodeBase64(String data) {
        try {
			return decodeBase64(data.getBytes("GB2312"));
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public static void main(String[] args) {
		...
		System.out.println(Encode64.encodeBase64("参数3功能点--可配置"));
		 String encoding = System.getProperty("file.encoding");
		   System.out.println("Default System Encoding:" + encoding);

			
		System.out.println(Encode64.decodeBase64("ss7K/TO5psTcteMtLb/JxeTWww=="));
	}
}
