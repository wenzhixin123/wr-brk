...
public class InitCheckOutUploadAction extends SinotransBaseAction {
/*
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		String agentConsigneeDesc = request.getParameter("agentConsigneeDesc1");
		if (ff != null && !RcUtil.isEmpty(ff.getFileName())) {
			String path = request.getRealPath("/");
			String fileName = uploadFile(ff, request.getRealPath("/upload"));
			String officeCode = getUser().getOfficeCode();
		...
		request.setAttribute("businessType", request
				.getParameter("businessType"));
		request.setAttribute("functionName", request
				.getParameter("functionName"));
		return mapping.findForward("uploadInitCheckOut");
	}*/
